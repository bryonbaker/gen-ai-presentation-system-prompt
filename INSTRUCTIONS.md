...
./FinOS/gen-ai-presentation-system-prompt/

Template: ./FinOS/0 - clean template.pptx
Output: ./FinOS/<presentation-name>.pptx
...
4. The script is executed in a Python virtual environment at `./FinOS/.venv`
...
3. Run it in the existing venv at `./FinOS/.venv`
...
- Always use the **virtual environment** at `./FinOS/.venv` (it has `python-pptx` installed)
- Always use the **template file** at `./FinOS/0 - clean template.pptx`
